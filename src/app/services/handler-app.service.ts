...
export class HandlerAppService {
  ...
  getPermissions(component:any){
    ...
    if(this.permissions != undefined){
      ...
      if(this.permissions[component].length > 0){
        this.permissions[component].forEach((permission:any) => {
          switch(permission){
            case 'ver':
  ...
  getPermissionsSecundary(component:any){
  ...
  shoWarning(title:any, message:any){
    this.closeShow();
    Swal.fire({
      title: title,
      html: message,
  ...
  showInfo(message:any, title:any, modulo:any){
    this.closeShow();
    Swal.fire({
      title: title,
      html: message,     
