...
import { ToasterConfig, ToasterService } from 'angular-toaster';
...
export class Tools {
    ...
    public showNotify(type:any, title:any, message:any) {
    ...
    getIdentity() {
        const currentUser = localStorage.getItem('myStoredUser');
        if (currentUser !== null) {
            this.identity = JSON.parse(currentUser);
        }
